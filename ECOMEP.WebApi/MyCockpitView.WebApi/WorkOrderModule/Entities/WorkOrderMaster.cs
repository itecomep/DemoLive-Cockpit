...
public class WorkOrderMaster : BaseEntity
{
    [Required]
    public string TypologyTitle { get; set; }
    public virtual ICollection<WorkOrderMasterStage> WorkOrderMasterStages { get; set; } = new List<WorkOrderMasterStage>();
}

public class WorkOrderMasterConfiguration : IEntityTypeConfiguration<WorkOrderMaster>
{
    public void Configure(EntityTypeBuilder<WorkOrderMaster> builder)
    {
