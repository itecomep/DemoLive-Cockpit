...
public class ContactWorkOrderAttachment : BaseBlobEntity
{
...
public class ContactWorkOrderAttachmentConfiguration : IEntityTypeConfiguration<ContactWorkOrderAttachment>
{
    public void Configure(EntityTypeBuilder<ContactWorkOrderAttachment> builder)
    {
...
.HasDefaultValue(false);
        ...
        builder.HasQueryFilter(x => !x.IsDeleted);
        builder
            .HasOne(u => u.ContactWorkOrder)
            .WithMany(c => c.Attachments)
            .HasForeignKey(x => x.ContactWorkOrderID).IsRequired();
    }
}