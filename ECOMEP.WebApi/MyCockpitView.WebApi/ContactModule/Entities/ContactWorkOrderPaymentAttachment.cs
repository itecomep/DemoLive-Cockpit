...
public class ContactWorkOrderPaymentAttachment : BaseBlobEntity
{
    public int ContactWorkOrderPaymentID { get; set; }

    public virtual ContactWorkOrderPayment? ContactWorkOrderPayment { get; set; }
}

public class ContactWorkOrderPaymentAttachmentConfiguration : IEntityTypeConfiguration<ContactWorkOrderPaymentAttachment>
{
    public void Configure(EntityTypeBuilder<ContactWorkOrderPaymentAttachment> builder)
    {
