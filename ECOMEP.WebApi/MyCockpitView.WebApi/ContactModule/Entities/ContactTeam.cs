...
public class ContactTeam : BaseEntity
{
    ...
    public virtual ICollection<ContactTeamMember> Members { get; set; }=new HashSet<ContactTeamMember>();

}

public class ContactTeamConfiguration : IEntityTypeConfiguration<ContactTeam>
{
    public void Configure(EntityTypeBuilder<ContactTeam> builder)
    {
