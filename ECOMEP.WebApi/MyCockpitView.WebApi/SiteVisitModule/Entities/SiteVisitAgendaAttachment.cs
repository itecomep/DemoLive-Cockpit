...
public class SiteVisitAgendaAttachment: BaseBlobEntity
{
    [Required]
    public int SiteVisitAgendaID { get; set; }

    public virtual SiteVisitAgenda? SiteVisitAgenda { get; set; }

}
public class SiteVisitAgendaAttachmentConfiguration : IEntityTypeConfiguration<SiteVisitAgendaAttachment>
{
    public void Configure(EntityTypeBuilder<SiteVisitAgendaAttachment> builder)
    {
