...
namespace MyCockpitView.WebApi.ImageLibraryModule.Entities;
public class ImageLibraryEntity : BaseBlobEntity
{
    public string? Category { get; set; }
}
public class ImageLibraryEntityConfiguration : IEntityTypeConfiguration<ImageLibraryEntity>
{
    public void Configure(EntityTypeBuilder<ImageLibraryEntity> builder)
    {
