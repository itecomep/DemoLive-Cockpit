...
public class AssetAttributeMaster : BaseEntity
{
    [StringLength(255)]
...
public class AssetAttributeMasterConfiguration : IEntityTypeConfiguration<AssetAttributeMaster>
{
    public void Configure(EntityTypeBuilder<AssetAttributeMaster> builder)
    {
