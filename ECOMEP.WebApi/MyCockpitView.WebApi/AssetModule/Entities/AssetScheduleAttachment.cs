...
public class AssetScheduleAttachment : BaseBlobEntity
{
    public int AssetScheduleID { get; set; }
    public virtual AssetSchedule? AssetSchedule { get; set; }
}

public class AssetScheduleAttachmentConfiguration : IEntityTypeConfiguration<AssetScheduleAttachment>
{
    public void Configure(EntityTypeBuilder<AssetScheduleAttachment> builder)
    {
...
.HasDefaultValue(false);
        ...
        builder.HasQueryFilter(x => !x.IsDeleted);
        builder
            .HasOne(u => u.AssetSchedule)
            .WithMany(c => c.Attachments)
            .HasForeignKey(x => x.AssetScheduleID).IsRequired();
    }
}
