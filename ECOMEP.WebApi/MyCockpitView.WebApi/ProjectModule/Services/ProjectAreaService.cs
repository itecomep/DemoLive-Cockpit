...
public interface IProjectAreaService : IBaseEntityService<ProjectArea>
{
}

public class ProjectAreaService : BaseEntityService<ProjectArea>, IProjectAreaService
{
  
    public ProjectAreaService(EntitiesContext db) : base(db)  {  
    }
    

        public IQueryable<ProjectArea> Get(IEnumerable<QueryFilter>? Filters = null, string? Search = null, string? Sort = null)
        {

            IQueryable<ProjectArea> _query = base.Get(Filters);
            ...
            if (Filters != null)
            {
                ...
                {
                    var predicate = PredicateBuilder.False<ProjectArea>();
