...
public class ProjectWorkOrderMaster : BaseEntity
{
    ...
    public virtual ICollection<ProjectWorkOrderSegmentMaster> Segments { get; set; } = new List<ProjectWorkOrderSegmentMaster>();

}

public class ProjectWorkOrderMasterConfiguration : IEntityTypeConfiguration<ProjectWorkOrderMaster>
{
    public void Configure(EntityTypeBuilder<ProjectWorkOrderMaster> builder)
    {
