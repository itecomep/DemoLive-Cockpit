...
public class ProjectWorkOrderSegmentMaster : BaseEntity
{
...
public class ProjectWorkOrderSegmentMasterConfiguration : IEntityTypeConfiguration<ProjectWorkOrderSegmentMaster>
{
    public void Configure(EntityTypeBuilder<ProjectWorkOrderSegmentMaster> builder)
    {
