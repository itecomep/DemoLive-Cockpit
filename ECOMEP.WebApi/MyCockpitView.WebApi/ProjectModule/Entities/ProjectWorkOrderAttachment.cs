...
public class ProjectWorkOrderAttachment : BaseBlobEntity
{
...
public class ProjectWorkOrderAttachmentConfiguration : IEntityTypeConfiguration<ProjectWorkOrderAttachment>
{
    public void Configure(EntityTypeBuilder<ProjectWorkOrderAttachment> builder)
    {
