...
{
    public class ProjectStageDelivery : BaseEntity
    {
        [Required]
        [StringLength(255)]
    ...
    public class ProjectStageDeliveryConfiguration : IEntityTypeConfiguration<ProjectStageDelivery>
    {
        public void Configure(EntityTypeBuilder<ProjectStageDelivery> builder)
        {
    ...
    .HasDefaultValue(false);
            ...
            builder
                .HasOne(u => u.ProjectStage)
                .WithMany(c => c.Deliveries)
                .HasForeignKey(x => x.ProjectStageID).IsRequired();
