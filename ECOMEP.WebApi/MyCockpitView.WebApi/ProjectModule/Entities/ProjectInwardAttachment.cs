...
public class ProjectInwardAttachmentConfiguration : IEntityTypeConfiguration<ProjectInwardAttachment>
{
...
.HasDefaultValue(false);
        ...
        builder.HasQueryFilter(x => !x.IsDeleted);
        builder
            .HasOne(u => u.ProjectInward)
            .WithMany(c => c.Attachments)
            .HasForeignKey(x => x.ProjectInwardID).IsRequired();
    }
}