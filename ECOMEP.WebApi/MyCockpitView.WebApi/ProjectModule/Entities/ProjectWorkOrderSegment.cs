...
public class ProjectWorkOrderSegment : BaseEntity
{
    [Required]
    [StringLength(255)]
...
public class ProjectWorkOrderSegmentConfiguration : IEntityTypeConfiguration<ProjectWorkOrderSegment>
{
    public void Configure(EntityTypeBuilder<ProjectWorkOrderSegment> builder)
    {
