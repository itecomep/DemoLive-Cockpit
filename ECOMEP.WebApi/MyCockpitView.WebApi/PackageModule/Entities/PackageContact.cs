...
public class PackageContact : BaseEntity
{
...
public class PackageContactConfiguration : IEntityTypeConfiguration<PackageContact>
{
    public void Configure(EntityTypeBuilder<PackageContact> builder)
    {
