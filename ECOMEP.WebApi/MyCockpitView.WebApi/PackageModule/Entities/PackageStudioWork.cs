...
public class PackageStudioWork : BaseEntity
{
    ...
    public virtual ICollection<PackageStudioWorkAttachment> Attachments { get; set; } = new List<PackageStudioWorkAttachment>();
...
public class PackageStudioWorkConfiguration : IEntityTypeConfiguration<PackageStudioWork>
{
    public void Configure(EntityTypeBuilder<PackageStudioWork> builder)
    {
