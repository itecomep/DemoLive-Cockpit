...
public class PackageStudioWorkAttachment : BaseBlobEntity
{

    public int PackageStudioWorkID { get; set; }

    public virtual PackageStudioWork? PackageStudioWork { get; set; }
}

public class PackageStudioWorkAttachmentConfiguration : IEntityTypeConfiguration<PackageStudioWorkAttachment>
{
    public void Configure(EntityTypeBuilder<PackageStudioWorkAttachment> builder)
    {
...
.HasDefaultValue(false);
        ...
        builder.HasQueryFilter(x => !x.IsDeleted);
        builder
            .HasOne(u => u.PackageStudioWork)
            .WithMany(c => c.Attachments)
            .HasForeignKey(x => x.PackageStudioWorkID).IsRequired();
    }
}
