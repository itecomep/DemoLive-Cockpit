...
@Component({
    selector: 'wf-task-studio-work-item',
    templateUrl: './wf-task-studio-work-item.component.html',
    styleUrls: ['./wf-task-studio-work-item.component.scss'],
    standalone: true,
    imports: [NgIf, MatTooltipModule, MatButtonModule, MatIconModule, DatePipe]
})
export class WfTaskStudioWorkItemComponent implements OnInit
{
