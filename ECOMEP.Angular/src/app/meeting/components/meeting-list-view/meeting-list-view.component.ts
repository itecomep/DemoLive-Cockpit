...
import { MeetingPagedListComponent } from '../meeting-paged-list/meeting-paged-list.component';
...
export class MeetingListViewComponent implements OnInit, OnDestroy
{
  ...
  @ViewChild(MeetingPagedListComponent) pagedList!: MeetingPagedListComponent;
  readonly nameOfEntity = this.config.NAMEOF_ENTITY_MEETING;
  readonly defaultRoute = this.config.ROUTE_MEETING_LIST;
  ...
  readonly defaultFilters = [
    ...
    { key: 'attendeeOrCreatedByContactID', value: this.authService.currentUserStore ? this.authService.currentUserStore.contact.id.toString() : '0' },
  ...
  showAllFilterKey = 'attendeeOrCreatedByContactID';
