...
@Component({
  selector: 'app-meeting-time-entry-list',
  standalone: true,
  imports: [
    CommonModule,
    MatButtonModule,
  ...
  templateUrl: './meeting-time-entry-list.component.html',
  styleUrls: ['./meeting-time-entry-list.component.scss']
})
export class MeetingTimeEntryListComponent {
  form!: FormGroup;
  wfTask!: WFTask;
