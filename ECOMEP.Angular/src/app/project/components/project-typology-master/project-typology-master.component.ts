...
import { ReactiveFormsModule, FormsModule, FormBuilder, FormArray, AbstractControl, FormControl, Validators, FormGroup } from '@angular/forms';
...
@Component({
  selector: 'app-project-typology-master',
  standalone: true,
  ...
  templateUrl: './project-typology-master.component.html',
  styleUrls: ['./project-typology-master.component.scss']
})
export class ProjectTypologyMasterComponent {
  constructor(
     private dialogRef: MatDialogRef<ProjectTypologyMasterComponent>,
