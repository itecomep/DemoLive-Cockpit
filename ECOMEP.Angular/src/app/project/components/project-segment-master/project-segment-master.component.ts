...
import { FormBuilder, FormArray, AbstractControl, FormControl, Validators, FormGroup, FormsModule, ReactiveFormsModule } from '@angular/forms';
...
@Component({
  selector: 'app-project-segment-master',
  standalone: true,
  ...
  templateUrl: './project-segment-master.component.html',
  styleUrls: ['./project-segment-master.component.scss']
})
export class ProjectSegmentMasterComponent {
constructor(
     private dialogRef: MatDialogRef<ProjectSegmentMasterComponent>,
