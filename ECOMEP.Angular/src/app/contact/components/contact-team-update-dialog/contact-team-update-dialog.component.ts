...
import { Contact, ContactAddress, ContactEmail, ContactPhone } from '../../models/contact';
...
@Component({
  selector: 'app-contact-team-update-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './contact-team-update-dialog.component.html',
  styleUrls: ['./contact-team-update-dialog.component.scss']
})
export class ContactTeamUpdateDialogComponent {
  ...
  constructor(
    ...
    private dialog: MatDialogRef<ContactTeamUpdateDialogComponent>,
